...
Summary:
        ...
        The example assumes that the processing is done in place, i.e. the result 
        from the processing step can overwrite the input buffer. 
...
Description:
	This directory contains an example program demonstrating how to use
        ...
        from the processing step can overwrite the input buffer.   
How to run:
	The actual executable is called 'single_buffer_list'
