...
Summary:
        ...
        double buffering technique.  The example assumes that the processing is
...
Description:
	This directory contains an example program demonstrating how to use
        ...
        main memory using double buffering technique. The processing is done
        in place. 
...
How to run:
	The actual executable is called 'double_buffer'
